...
def test_intake_donations():
    ...
    assert Donor.intake_donations([]) == []


def test_normalize_name():
    assert Donor.normalize_name('  jim     bob    ') == 'Jim Bob'
    assert Donor.normalize_name(
...
def test_donor_thankyou():
    ...
    assert (
        d1.thankyou(all_donations=True) ==
    ...
    assert (
        d2.thankyou(all_donations=True) ==
    ...
    assert (
        d3.thankyou(all_donations=True) ==
        'Dear Dad,\nThank you for your generous gifts of ' +
    ...
    assert (
        d4.thankyou(all_donations=True) ==
        'Dear Donald Trump,\nThank you for your generous gift of ' +
    ...
    assert (
        d5.thankyou(all_donations=True) ==
        'Dear Billy Neighbor,\nThank you for your generous gifts of ' +
...
def test_donor_set():
    ...
    d.donations = [40, 30, 200000.00]
    assert d.donations == [40, 30, 200000]
...
def test_donorlist_set():
    d4 = Donor('Debbie', 10)
    l1 = DonorList(d1, d2, d3, d4)
    l1['Debbie'] = [500, 15.89]
    assert Donor('Debbie', [500, 15.89]) in l1
