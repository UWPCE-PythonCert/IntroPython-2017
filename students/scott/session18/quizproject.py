...
class Record:
    ...
    def __init__(self,
        ...
        self.meet = meet.strip()
        self.quiznum = quiznum.strip()
        self.quiz_type = quiz_type.strip()
        self.room = room.strip()
        self.quizmaster = quizmaster.strip()
        self.correct = correct
        self.incorrect = incorrect
        self.corr_bonus = corr_bonus
        self.incorr_bonus = incorr_bonus
        self.foul = foul
        self.third_bonus = third_bonus.strip()
        self.fourth_bonus = fourth_bonus.strip()
        self.fifth_bonus = fifth_bonus.strip()
        self.ind_score = ind_score
        self.qo_question_num = qo_question_num
        self.eo_question_num = eo_question_num
...
def create_sample():
    ...
    """
    dummy = Record(fullname='Andrew Borden',
                   team='ABC1',
                   church='ABC',
                   year='2017-2018',
                   meet='5',
