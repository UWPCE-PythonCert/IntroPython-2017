...
class TestFunctions():
    ...
    def test_donor_init(self, mocked_input):
        name = "Ada Lovelace"
        amt = 345
        d = Donor(name)
        d.add_donation(amt)
    ...
    def test_name(self, mocked_input):
        name = "Ada Lovelace"
        amt = 345
        d = Donor(name)
        d.add_donation(amt)
    ...
    def test_add_donation(self, mocked_input):
        name = "Ada Lovelace"
        amt = 345
        d = Donor(name)
        d.add_donation(amt)
    ...
    def test_list_names(self, mocked_input):
        name = "Ada Lovelace"
        amt = 345
        d = Donor(name)
        d.add_donation(amt)
    ...
    def test_generate_report_data(self, mocked_input):
    ...
    def test_setup_table(self, mocked_input):
        t = Transactions()
    ...
    def test_setup_body(self, mocked_input):
        name, amt = ("Ada Lovelace", 345)
        d = Donor(name)
        d.add_donation(amt)
        name2, amt2, amt3 = ("Marge Simpson", 500, 1000)
    ...
    def test_letter_string(self, mocked_input):
        name, amt = ("Ada Lovelace", 345)
        d = Donor(name)
        d.add_donation(amt)
    ...
    def test_mult_donations(self, mocked_input):
    ...
    def test_filter_donations(self, mocked_input):
        name, amt, amt2, amt3 = ("Ada Lovelace", 350, 700, 100)
        d = Donor(name)
        d.add_donation(amt)
        d.add_donation(amt2)
    ...
    def test_filter_correct_donations(self, mocked_input):
        name, amt, amt2, amt3 = ("Ada Lovelace", 350, 700, 100)
        d = Donor(name)
        d.add_donation(amt)
        d.add_donation(amt2)
    ...
    def test_total_donations(self, mocked_input):
        name, amt, amt2, amt3 = ("Ada Lovelace", 350, 700, 100)
        d = Donor(name)
        d.add_donation(amt)
        d.add_donation(amt2)
